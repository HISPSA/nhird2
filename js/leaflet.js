    ...
    o.Marker.include(a), o.Circle.include(a), o.CircleMarker.include(a), o.Polyline.prototype.toGeoJSON = function() {
        ...
        _initLayout: function() {
			...
			if (this.options.opacitySlider) {
				this._separator = o.DomUtil.create("div", t + "-separator", n), this._slider = o.DomUtil.create("div", t + "-slider", n);
				var l = this._layers;
        ...
        _onInputClick: function() {
            ...
            for (var r = n.length - 1; r >= 0; r--) t = n[r], e = ((t.className == 'leaflet-control-layers-selector') ? this._getLayer(t.layerId).layer : null), i = this._map.hasLayer(e), t.checked && !i ? o.push(e) : !t.checked && i && s.push(e);
            for (r = 0; r < s.length; r++) this._map.removeLayer(s[r]);
            for (r = 0; r < o.length; r++) this._map.addLayer(o[r]);
            this._handlingClick = !1, this._refocusOnMap()
        },
        _checkDisabledLayers: function() {
            for (var t, e, n = this._form.getElementsByTagName("input"), o = this._map.getZoom(), s = n.length - 1; s >= 0; s--) t = n[s], e = ((t.className == 'leaflet-control-layers-selector') ? this._getLayer(t.layerId).layer : null), t.disabled = ((e != null) ? e.options.minZoom !== i && o < e.options.minZoom || e.options.maxZoom !== i && o > e.options.maxZoom : false)
        },
        _expand: function() {
            return this.expand()
        },
